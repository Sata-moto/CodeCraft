...
pair<double, double> Rotate(pair<double, double>, double);       //测试1                                               // 旋转向量
...
double Dist(double, double, double, double);                       //测试2                                             // 计算两个点之间的距离（double点对形式）
double Dist(pair<double, double>, pair<double, double>);                  //测试3                                      // 计算两个点之间的距离（pair形式）
